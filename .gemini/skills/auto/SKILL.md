...
> 🐙 Autopus v0.4 | auto-discription | full
...
| qa ⚡ | QAMESH project QA mesh: plan, run, evidence, feedback |
...
Usage: `/auto qa plan --format json`, `/auto qa run --feedback-to gemini --format json`, `/auto qa evidence --input manifest.json --output .autopus/qa/evidence --surface browser --lane golden --scenario S1`, `/auto qa feedback --to gemini --evidence manifest.json`
