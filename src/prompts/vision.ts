...
const VISION_INSTRUCTION = `An image of the frame is attached. Use it to disambiguate visual intent (e.g., button labels, layout) when the node tree is insufficient. If the image and node tree disagree, set "intent_mismatch": true and explain in the "intent" field.`;
