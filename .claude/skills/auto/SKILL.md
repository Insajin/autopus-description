...
Usage: `/auto qa plan --format json`, `/auto qa run --feedback-to codex --format json`, `/auto qa evidence --input manifest.json --output .autopus/qa/evidence --surface browser --lane golden --scenario S1`, `/auto qa feedback --to codex --evidence manifest.json`
